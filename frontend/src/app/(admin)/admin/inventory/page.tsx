...
const InventoryManagement = () => {
  ...
  useEffect(() => {
    ...
    inventoryCreationMutationError,
    inventoryCreationMutationErrorMessage,
    deletingInventoryError,
    deletingInventoryErrorMessage
  ]);
  ...
  const handleCreateInventoryItem: MRT_TableOptions<InventoryItem>['onCreatingRowSave'] = async ({ values, table }) => {
    console.log('here');
