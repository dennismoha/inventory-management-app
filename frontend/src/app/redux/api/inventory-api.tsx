...
import { ProductApiResponse, NewProductPayload } from '@/app/(admin)/admin/products/interface/products-Interface';
import {
  Category,
  CategoryResponse,
  SubCategory,
...
import { Unit, UnitApiResponse, UnitBodyPayload } from '@/app/(admin)/admin/units/interface/units-interface'; // Import the Unit types
...
import { Order, OrderProductResponse, OrderProducts, OrderResponse } from '@/app/(admin)/admin/orders/interfaces/orders-interface';
import {
  InventoryItem,
