  ...
  return (
    <div className="bg-gray-50">
      ...
      <nav className="bg-green-700 p-4 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="space-x-6 hidden md:flex text-lg">
            ...
            {session !== null ? (
              <>
                {' '}
                <a onClick={() => signOut()} href="/logout" className="text-white hover:text-green-200">
                  logout
                </a>
              </>
            ) : (
              <>
                {' '}
                <button onClick={() => signIn('github', { redirectTo: '/' })} className="text-white hover:text-green-200">
                  login
                </button>
              </>
            )}
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed inset-0 bg-black bg-opacity-50 z-50 transition-all duration-300 ${menuOpen ? 'block' : 'hidden'}`}
          onClick={toggleMenu}
        >
          <div
          ...
          >
            <div className="flex justify-between items-center p-6">
              <div className="text-3xl font-extrabold text-green-700">Warehouse X</div>
      ...
      {/* Hero Section */}
      <section className="relative bg-cover bg-center h-[80vh]" style={{ backgroundImage: 'url(https://via.placeholder.com/1500x900)' }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col items-center justify-center h-full text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-6">
            Stay ahead with real-time inventory tracking, order management, and seamless warehouse operations.
          </p>
          <a
            href="/inventory"
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-semibold text-green-700 mb-10">Efficient Inventory Management</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-green-700 mb-4">Animal Feeds</h3>
              <p className="text-gray-600">
                Track all types of animal feeds, including grains, supplements, and specialty feeds. Keep your stock levels updated at all
                times.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-green-700 mb-4">Agricultural Products</h3>
              <p className="text-gray-600">
                From seeds to fertilizers, manage all your agricultural products seamlessly and ensure your stock is always ready for use.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-green-700 mb-4">Warehouse Operations</h3>
              <p className="text-gray-600">
                Monitor your warehouse activities such as stock movement, order picking, and shipping to ensure smooth operations and timely
                deliveries.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-green-700 text-white py-8">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="text-lg">
            <p>© 2025 Warehouse X - Animal Feeds & Agriculture. All rights reserved.</p>
          </div>
