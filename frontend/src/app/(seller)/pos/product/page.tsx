...
const Home = () => {
  const { data: InventoryItemsData, isLoading, isError } = useGetInventoryItemsQuery();
  ...
  return (
    ...
    <div className={`grid  md:grid-cols-3 sm:grid-cols-2 gap-5 ${statusTabCart === false ? '' : 'lg:grid-cols-2 gap-1'}`}>
