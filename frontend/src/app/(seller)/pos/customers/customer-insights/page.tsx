    ...
    transactions.forEach((transaction) => {
      transaction.TransactionProduct?.forEach((product) => {
        productCounts[product.productName] =
          (productCounts[product.productName] || 0) + product.quantity;
      });
    });
            ...
            <>
              ...
              <div className="border-t pt-4">
                ...
                <div className="flex justify-between mt-4 font-bold">
                  ...
                  <span>
                    {calculateTotalSales(customer.totalSales).toFixed(2)}
                  </span>
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                <h3 className="text-xl font-semibold flex justify-between items-center">
                  ...
                  <button
                    ...
                    onClick={() => toggleTransactions(customer.customerId)}
                  >
                ...
                {expandedTransactions === customer.customerId && (
                  <>
                      ...
                      <div key={transaction.transactionId}>
                        ...
                        <div className="mt-2 pl-4">
                          <table className="min-w-full table-auto border-collapse">
                            ...
                            <tbody>
                              {transaction.TransactionProduct?.map(
                                (product, idx) => (
                                  <tr key={idx}>
                                    ...
                                    <td className="border px-4 py-2">
                                      {product.productSubTotalCost!.toFixed(2)}
                                    </td>
                                    <td className="border px-4 py-2">
                    ...
                    <div className="mt-4">
                      <h4>
                        Transactions Over Time. Day the highest transactions
                        were made
                      </h4>
                      <BarChart
                        series={[
                          {
                            data: getTransactionDateData(
                    ...
                    <div className="mt-4">
                      <h4>
                        Product Distribution with resepct to the quantity of
                        item sold the most
                      </h4>
                      <PieChart
                        series={[
